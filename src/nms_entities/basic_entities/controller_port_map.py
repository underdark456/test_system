...
class ControllerPortMap(AbstractBasicObject):
    """
    NMS Controller Port map class.
    ...
    >>> pm = ControllerPortMap(driver, 0, -1, params={'external_port': 2048, 'internal_ip': '172.16.22.1', 'internal_port': 3675})
    >>> pm.save()
    Instantiates a new Port map for a Controller ID 0.
    Applies the port map to NMS.

    >>> pm = ControllerPortMap(driver, 0, 3)
    ...
    def __init__(self, driver: AbstractHttpDriver, controller_id: int, port_map_id: int, params: dict = None):
        """
        ...
        :raises src.exceptions.ObjectNotFoundException:  if port map ID is not found
        """
        super().__init__(driver, controller_id, port_map_id, params)
    ...
    def _get_create_path(self) -> str:
        ...
        """
        return PathsManager.controller_port_map_create(self._driver.get_type(), self._parent_id)
    ...
    def _get_read_path(self) -> str:
        ...
        """
        return PathsManager.controller_port_map_read(self._driver.get_type(), self._object_id)
    ...
    def _get_update_path(self) -> str:
        ...
        """
        return PathsManager.controller_port_map_update(self._driver.get_type(), self._object_id)
    ...
    def _get_delete_path(self) -> str:
        ...
        """
        return PathsManager.controller_port_map_delete(self._driver.get_type(), self._object_id)
    ...
    def _get_list_path(self) -> str:
        ...
        """
        return PathsManager.controller_port_map_list(self._driver.get_type(), self._parent_id)

    @classmethod
    def port_map_list(cls, driver: AbstractHttpDriver, controller_id: int, skip=None, max_=None, vars_=None):
        """
        ...
        """
        _path = PathsManager.controller_port_map_list(driver.get_type(), controller_id, skip, max_, vars_)
