from src.enum_types_constants import ControllerModes, RouteTypes, ModcodModes, TdmaInputModes, RollofModes, TdmaModcod, \
    DemodulatorInputModes, StationModes, CheckboxStr, Checkbox
