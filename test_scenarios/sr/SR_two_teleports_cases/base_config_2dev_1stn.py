...
class _Base2Dev1StnCase(CustomTestCase):
    """Base config for SR_two_teleports_cases: 2 devices, 1 station, 1 dummy station"""
    ...
    def set_up_class(cls):
        ...
        if not (state1 == 'Up' and state2 == 'Redundant') and not \
            ...
            test_api.error(f'Devices\' states should be Up and Redundant, current states: {state1}, {state2}')
