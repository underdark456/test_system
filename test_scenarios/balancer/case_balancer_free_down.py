...
class BalancerFreeDownCase(_Base3Ctrl1BalCase):
    """The test to check stations switching from down ctrl 2.1"""
    ...
    def test_balancer_free_down(self):
        nms_api.update('bal_controller:0', {'free_down': CheckboxStr.ON, 'down_time': '60'})
        ...
        # Change settings for controller Inroute-1 to go down
        nms_api.update('controller:1', {'mf1_rx': 1102000, 'no_stn_check': '0'})
        nms_api.wait_ticks(6)
        time.sleep(60)
        ...
        nms_api.update('controller:2', {'mf1_rx': 1112000, 'no_stn_check': '0'})
        nms_api.wait_ticks(5)
        time.sleep(30)
