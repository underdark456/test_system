...
class BalancerSwDown1Case(_Base3Ctrl1BalCase):
    """The test to check down stations are switched in pass1 2.10"""
    ...
    def test_balancer_sw_down(self):
        nms_api.update('bal_controller:0', {'load_higher': '70', 'switch_down': '1'})
