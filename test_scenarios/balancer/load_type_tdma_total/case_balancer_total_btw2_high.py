...
class BalancerTotalBtw2HighCase(_Base2Ctrl1BalTotalCase):
    """The test to check 2 stations are switched due to load_higher limit 2.4.3"""
    ...
    def test_balancer_btw2_high(self):

        nms_api.update('bal_controller:0', {'load_higher': '25'})
