...
options_path = 'test_scenarios.balancer.load_type_tdma_total'
backup_name = 'default_config.txt'


class BalancerBtw21StSwTotal(_Base2Ctrl1BalTotalCase):
    """The test to check 1 station which exceed load_higher1 limit switching from ctrl with load_type TDMA_Total 2.4.1"""
