...
from test_scenarios.balancer.load_type_cir.base_config_2ctrl_1bal_cir import _Base2Ctrl1BalCirCase

options_path = 'test_scenarios.balancer.load_type_cir'
backup_name = 'default_config.txt'


class BalancerBtw21StSwCIR(_Base2Ctrl1BalCirCase):
    """The test to check 1 station which exceed load_higher1 limit switching from ctrl with load_type TDMA_CIR 2.4.1"""
